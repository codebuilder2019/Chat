...
import servidorUsuarios.service.UsersDB;
...
public class GestionUsuariosImpl extends UnicastRemoteObject implements GestionUsuariosInt
{
    ...
    public int registarUsuario(String nombre, String role, String nombreUsuario, String clave) throws IOException {
        return this.usersDB.addUser(nombre, role, nombreUsuario, clave);
    }
    ...
    public boolean ActualizarUsuario(User user) throws IOException {
        return this.usersDB.updateById(user.getId(), user.getName(), user.getRole(), user.getUser(), user.getPassword());
    }
