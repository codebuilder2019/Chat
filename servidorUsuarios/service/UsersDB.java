package servidorUsuarios.service;
...
public class UsersDB {
    ...
    public int addUser(String name, String role, String user, String password) throws IOException{
        idCount++;

        User newUser = new User(idCount, name, role, user, password);
    ...
    public void connect() throws FileNotFoundException, IOException {
        ...
        while ((row = csvReader.readLine()) != null) {
            ...
            User newUser = new User(Integer.parseInt(stringUser[0]), stringUser[1], stringUser[2], stringUser[3], stringUser[4]);
            this.users.add(newUser);
        }
    ...
    public boolean updateById(int id, String name, String role, String user, String password) throws IOException{
